...
def google_drive_download(url_id, location):
    ...
    folder = service.files().list(
            q=f"name contains '{url_id}' and mimeType='application/vnd.google-apps.folder'",
...
url_id = '1n_alr6WFQZfw4dcAmyxow4V8FC67XD8p'
location = '/home/is/kosuke-t/scripts/make_data/wmt_metrics/cache/WMT20_data'
google_drive_download(url_id, location)
